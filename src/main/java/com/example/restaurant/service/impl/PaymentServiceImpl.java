...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Override public Payment createPayment(Payment p){
        p.setPaymentTime(LocalDateTime.now());
        return repo.save(p);
    }
    @Override public List<Payment> getAll(){ return repo.findAll(); }
    @Override public Payment getById(Integer id){ return repo.findById(id).orElseThrow(); }
}
